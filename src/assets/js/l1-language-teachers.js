...
const L1_LANGUAGE_GROUPS = [
  { group: 1, teacher: 'Tarana Kalantarova', language: 'French' },
  { group: 2, teacher: 'Latchine Bayramova', language: 'French' },
  { group: 3, teacher: 'Aytan Babaliyeva', language: 'French' },
  { group: 4, teacher: 'Vafa Guliyeva', language: 'French' },
  { group: 5, teacher: 'Tarana Kalantarova', language: 'French' },
  { group: 6, teacher: 'Irada Piriyeva', language: 'French' }
];

module.exports = L1_LANGUAGE_GROUPS;
